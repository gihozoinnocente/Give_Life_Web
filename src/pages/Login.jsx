        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-4xl font-bold text-gray-900">Give Life</h1>
            </div>
            <p className="text-xl text-gray-600 leading-relaxed">
              Join our community of life-savers. Every drop counts in making a difference.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Save Lives</h3>
                <p className="text-gray-600 text-sm">Your donation can save up to three lives</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Find Blood Fast</h3>
                <p className="text-gray-600 text-sm">Connect with donors in real-time</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">See the lives you've touched</p>
              </div>
            </div>
          </div>
        </div>
